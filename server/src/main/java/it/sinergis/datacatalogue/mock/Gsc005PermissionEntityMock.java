...
public class Gsc005PermissionEntityMock {
	 ...
	 * @return
	 */
	public Gsc005PermissionEntity createInstance() {
		// Primary Key values
	 ...
	 * @return
	 */
	public Gsc005PermissionEntity createInstance( Long id ) {
	 ...
	 * @return
	 */
	public List<Gsc005PermissionEntity> createList(int count) {
		List<Gsc005PermissionEntity> list = new LinkedList<Gsc005PermissionEntity>();		
